package cn.cnsjwx.common.utils.token;
...
import cn.cnsjwx.common.exceptions.NestedBusinessException;
...
public class TokenToolEncrypter  implements TokenBaseInter{
	...
	public  String encrypt(String str) {
		try {
			if(ecipher==null){
				...
				throw new NestedBusinessException("TOKEN_IS_ILLICIT");
			}
	...
	/* (non-Javadoc)
	 * @see cn.cnsjwx.common.utils.token.TokenBaseInter#productToken(java.lang.String[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.cnsjwx.common.utils.token.TokenBaseInter#productToken(java.lang.String, java.lang.String)
	 */
	@Override
