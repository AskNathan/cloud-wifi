package cn.cnsjwx.common.core.mybatis.interceptor;
import java.util.Properties;
import cn.cnsjwx.common.core.mybatis.dialect.Dialect;
...
public class PagePluging implements Interceptor {
    ...
    private static Log logger = LogFactory.getLog(PagePluging.class);
