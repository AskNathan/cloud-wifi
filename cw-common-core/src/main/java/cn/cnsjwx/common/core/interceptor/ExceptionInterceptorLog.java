 ...
 */
package cn.cnsjwx.common.core.interceptor;
...
public class ExceptionInterceptorLog implements ThrowsAdvice {
	 ...
	 */
	public void afterThrowing(Method method, Object[] args, Object target, NestedBusinessException ex) {

		log.info("==>ExceptionInterceptorLog.BizException");
		log.info("==>errCode:" + " errMsg:" + ex.getMessage());
